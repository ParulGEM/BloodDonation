...
const donationSchema = new Schema(
  {
    ...
    healthIssue: { type: Boolean, trim: true, default: "None" },
    ...
    medicineConsumption: { type: String, trim: true, default: "None" },
    ...
    lastSixMonth: { type: String, trim: true, default: "none" },
    sufferFrom: { type: String, trim: true, default: "none" },
    taking: { type: String, trim: true, default: "none" },
    surgeryHistoryString: { type: String, trim: true, default: "none" },
