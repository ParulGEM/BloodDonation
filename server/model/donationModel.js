...
const donationSchema = new Schema(
  {
    ...
    pulse: { type: Number, trim: true, required: true },
    hb: { type: Number, trim: true, required: true },
    bp: { type: String, trim: true, required: true },
    temperature: { type: String, trim: true, required: true },
    lastSixMonth: { type: String, trim: true, required: true },
    sufferFrom: { type: String, trim: true, required: true },
    taking: { type: String, trim: true, required: true },
    surgeryHistoryString: { type: String, trim: true, required: true },
