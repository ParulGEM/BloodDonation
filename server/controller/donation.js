...
const donationRequest = async (req, res, next) => {
  try {
...
const donationFilter = async (req, res, next) => {
  try {
    const {
      country,
      city,
...
const myDonation = async (req, res, next) => {
...
const donationLocation = async (req, res, next) => {
  const { key } = req.query;
  const bodyValidation = Joi.object({
